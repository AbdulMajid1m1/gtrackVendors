                        ...
                        <article key={index} className="rounded-xl bg-white p-3 shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300 ">
                            <a href="#">
                                ...
                                <div className="mt-3 flex justify-between px-2">
                                    <button className='h-auto w-auto px-4 py-1 text-sm bg-primary rounded-md text-white'>View</button>
                                    <p className="text-sm font-bold text-red-500">{item?.expiry_date}</p>
                                </div>
                            </a>
                        </article>
                    )
